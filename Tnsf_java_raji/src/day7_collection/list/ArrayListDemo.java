...
public class ArrayListDemo {
	...
	public static void main(String[] args) {
		...
		// reference class name as list and class name as array list
		System.out.println("Size : "+list1.size());
		System.out.println("Is list empty? "+list1.isEmpty());
		// adding the elements in the list, then we can know size, contains, remove
		list1.add(10);
		list1.add(20);
		list1.add(true);
		list1.add(false);
	...
	//	  System.out.println(list1.remove(20)); //4 - index System.out.println(list1);
		...
		// get is used to pick the 5th element not 5 value.
		...
		list1.clear(); // list will be empty, all the values have been deleted
		System.out.println("List is "+list1);
